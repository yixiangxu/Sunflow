...
public final class ShadingState implements Iterable<LightSample> {
    ...
    static ShadingState createFogState(ShadingState previous, Ray r, int i) {
    ...
    public final Color traceDepth(Ray r){
    	/*server.getScene().trace(r, istate);
    	if(!istate.hit())
    		return -1;
    	return r.getMax();*/
    	return server.getScene().traceDepth(r, istate);
    }
    
    public final Color objectColor(Ray r){
    	return server.traceColor(this, r, 0);
    }
    
    
    
    public final void setPoint(Point3 point){
    	p = point;
    }
    /**
